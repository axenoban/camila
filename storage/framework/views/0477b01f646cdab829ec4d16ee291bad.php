    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 mb-4 text-center text-md-start" data-aos="fade-up">
                ...
                <img src="<?php echo e(asset('images/logo/3.png')); ?>" alt="Logo Camila Footer" height="70" class="mt-3">
            </div>
            <div class="col-md-4 mb-4 text-center text-md-start" data-aos="fade-up" data-aos-delay="100">
                ...
                <ul class="list-unstyled">
                    <li><a href="/" class="text-secondary-light text-decoration-none hover-accent">Inicio</a></li>
                    <li><a href="/about" class="text-secondary-light text-decoration-none hover-accent">Nosotros</a></li>
                    <li><a href="/products" class="text-secondary-light text-decoration-none hover-accent">Productos</a></li>
                    <li><a href="/contact" class="text-secondary-light text-decoration-none hover-accent">Contacto</a></li>
                </ul>
            </div>
        ...
        <div class="text-center text-secondary-light">
            <p class="mb-0">© <?php echo e(date('Y')); ?> Importadora Textil Camila. Todos los derechos reservados.</p>
        </div>
    </div>
</footer><?php /**PATH C:\xampp\htdocs\laravel\camila-github\camila-textil\resources\views/components/footer.blade.php ENDPATH**/ ?>