...
<?php $__env->startSection('title', 'Contacto - Habla con Expertos Textiles | Importadora Camila'); ?>

<?php $__env->startSection('content'); ?>
<section class="hero-subpage d-flex align-items-center justify-content-center text-white" style="background-image: url('<?php echo e(asset('images/contact-hero.jpg')); ?>');" data-aos="fade-in">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\camila-github\camila-textil\resources\views/contact.blade.php ENDPATH**/ ?>