<?php $__env->startSection('title', 'Importadora Textil Camila - Textiles de Calidad en Santa Cruz'); ?>
...
<div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?php echo e(asset('images/banner/1.png')); ?>" class="d-block w-100 hero-img" alt="Telas Finas y Elegantes">
            <div class="carousel-caption d-flex flex-column justify-content-center h-100" data-aos="fade-up" data-aos-delay="300">
                ...
                <a href="/products" class="btn btn-accent btn-lg mt-3">Explorar Productos <i class="fas fa-arrow-right ms-2"></i></a>
            </div>
        </div>
        <div class="carousel-item">
            <img src="<?php echo e(asset('images/banner/2.png')); ?>" class="d-block w-100 hero-img" alt="Importación Directa de Telas">
            <div class="carousel-caption d-flex flex-column justify-content-center h-100" data-aos="fade-up" data-aos-delay="300">
                ...
                <a href="/contact" class="btn btn-accent btn-lg mt-3">Contáctanos Hoy <i class="fas fa-envelope ms-2"></i></a>
            </div>
        </div>
        <div class="carousel-item">
            <img src="<?php echo e(asset('images/banner/3.png')); ?>" class="d-block w-100 hero-img" alt="Variedad de Telas y Diseños">
            <div class="carousel-caption d-flex flex-column justify-content-center h-100" data-aos="fade-up" data-aos-delay="300">
                ...
                <a href="/about" class="btn btn-accent btn-lg mt-3">Conoce Nuestra Historia <i class="fas fa-info-circle ms-2"></i></a>
            </div>
        </div>
    </div>
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class="col" data-aos="fade-up" data-aos-delay="100">
                <div class="card h-100 border-0 shadow-lg text-center">
                    <img src="<?php echo e(asset('images/categorias/1.png')); ?>" class="card-img-top card-img-hover" alt="Telas para Moda">
                    <div class="card-body">
                        ...
                        <a href="/products#moda" class="btn btn-outline-accent btn-sm">Explorar <i class="fas fa-long-arrow-alt-right ms-2"></i></a>
                    </div>
                </div>
            </div>
            <div class="col" data-aos="fade-up" data-aos-delay="200">
                <div class="card h-100 border-0 shadow-lg text-center">
                    <img src="<?php echo e(asset('images/categorias/2.png')); ?>" class="card-img-top card-img-hover" alt="Telas para Hogar">
                    <div class="card-body">
                        ...
                        <a href="/products#hogar" class="btn btn-outline-accent btn-sm">Explorar <i class="fas fa-long-arrow-alt-right ms-2"></i></a>
                    </div>
                </div>
            </div>
            <div class="col" data-aos="fade-up" data-aos-delay="300">
                <div class="card h-100 border-0 shadow-lg text-center">
                    <img src="<?php echo e(asset('images/categorias/3.png')); ?>" class="card-img-top card-img-hover" alt="Telas Industriales">
                    <div class="card-body">
                        ...
                        <a href="/products#industrial" class="btn btn-outline-accent btn-sm">Explorar <i class="fas fa-long-arrow-alt-right ms-2"></i></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4 align-items-center">
            <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
                ...
                <div class="d-flex flex-wrap gap-2">
                    <a href="/cliente/login" class="btn btn-accent">Ingresar al portal</a>
                    <a href="/contact" class="btn btn-outline-accent">Solicitar acceso</a>
                </div>
            </div>
...
<section class="py-5 bg-cta text-white text-center" data-aos="zoom-in">
    <div class="container">
        ...
        <a href="/contact" class="btn btn-light btn-lg px-4 py-2 custom-shadow">¡Hablemos Ahora! <i class="fas fa-phone-alt ms-2"></i></a>
    </div>
</section>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\camila-github\camila-textil\resources\views/welcome.blade.php ENDPATH**/ ?>