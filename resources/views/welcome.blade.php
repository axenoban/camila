...
@section('title', 'Importadora Textil Camila - Textiles de Calidad en Santa Cruz')
...
<div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="{{ asset('images/banner/1.png') }}" class="d-block w-100 hero-img" alt="Telas Finas y Elegantes">
        ...
        <div class="carousel-item">
            <img src="{{ asset('images/banner/2.png') }}" class="d-block w-100 hero-img" alt="Importación Directa de Telas">
            <div class="carousel-caption d-flex flex-column justify-content-center h-100" data-aos="fade-up" data-aos-delay="300">
        ...
        <div class="carousel-item">
            <img src="{{ asset('images/banner/3.png') }}" class="d-block w-100 hero-img" alt="Variedad de Telas y Diseños">
            <div class="carousel-caption d-flex flex-column justify-content-center h-100" data-aos="fade-up" data-aos-delay="300">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class="col" data-aos="fade-up" data-aos-delay="100">
                <div class="card h-100 border-0 shadow-lg text-center">
                    <img src="{{ asset('images/categorias/1.png') }}" class="card-img-top card-img-hover" alt="Telas para Moda">
                    <div class="card-body">
            ...
            <div class="col" data-aos="fade-up" data-aos-delay="200">
                <div class="card h-100 border-0 shadow-lg text-center">
                    <img src="{{ asset('images/categorias/2.png') }}" class="card-img-top card-img-hover" alt="Telas para Hogar">
                    <div class="card-body">
            ...
            <div class="col" data-aos="fade-up" data-aos-delay="300">
                <div class="card h-100 border-0 shadow-lg text-center">
                    <img src="{{ asset('images/categorias/3.png') }}" class="card-img-top card-img-hover" alt="Telas Industriales">
                    <div class="card-body">
