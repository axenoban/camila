...
@section('title', 'Nuestra Historia - Importadora Textil Camila')

@section('content')
<section class="hero-subpage d-flex align-items-center justify-content-center text-white" style="background-image: url('{{ asset('images/about-hero.jpg') }}');" data-aos="fade-in">
    ...
    <div class="container">
        <div class="row align-items-center mb-5">
            <div class="col-md-6" data-aos="fade-right">
                <img src="{{ asset('images/equipo-profesional-2.jpg') }}" class="img-fluid rounded shadow-lg" alt="Nuestra Misión">
            </div>
        ...
        <div class="row align-items-center flex-row-reverse mb-5">
            <div class="col-md-6" data-aos="fade-left">
                <img src="{{ asset('images/vision-empresa.jpg') }}" class="img-fluid rounded shadow-lg" alt="Nuestra Visión">
            </div>
